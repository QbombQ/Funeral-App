...
const NavigationHeader: React.FC = () => {
    ...
    return (
        <>
            ...
            />
            <View
                style={tw`mt-[44px] w-full flex justify-center items-center px-[14px] h-[38px]`}
            >
                <View
                ...
                >
                    ...
                    >
                        ...
                        {showLogoutOption &&
                            <View
                                style={tw`absolute bottom-[-40px] right-[15px] gap-[3px] flex justify-end items-end z-[20]`}
                            >
                                <Image source={require("@/assets/images/Polygon 2.png")} />
                                <TouchableOpacity
                                    onPress={()=>{showLogOutModal(),showLogoutItem()}}
                                    style={tw`w-[111px] h-[26px] z-[20]`}
                                >
